...
# -*- coding: utf-8 -*-
"""
DEVIA - Mode Clair/Sombre Session 1 v3
- FIX : place 'themes' AVANT DeviaMain pour eviter Temporal Dead Zone
- Identique a v2 pour le reste
"""
...
backup_name = f"devia.jsx.backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}_before_theme_v3"
...
# ================================================================
# MOD 0 : SUPPRIMER les const globales cardStyle/inputStyle/btnPrimary/btnSecondary
# ================================================================
...
# Cette fois on les remplace par un commentaire seulement (pas l'objet themes)
new_globals = '''// Les styles cardStyle/inputStyle/btnPrimary/btnSecondary
// sont definis dynamiquement DANS DeviaMain selon themeMode (voir themes plus haut)'''

if "Les styles cardStyle/inputStyle/btnPrimary/btnSecondary" in content:
    print("[INFO] Const globales deja supprimees")
elif old_globals in content:
    content = content.replace(old_globals, new_globals, 1)
    print("[OK] Const globales supprimees")
    modifs += 1
else:
...
# ================================================================
# NOUVEAU MOD : Inserer 'themes' AU DEBUT du fichier (apres les imports)
# pour eviter Temporal Dead Zone
# ================================================================

# On cible la fin des imports : on cherche le dernier import
# Strategie : on cherche le marqueur 'function getZone' qui est la 1ere fonction
# definie dans le fichier (ligne 48 d'apres le grep precedent)

old_first_fn = 'function getZone(commune, altitude) {'

new_with_themes_top = '''// ====== Palettes Theme (Mode Clair / Sombre) ======
...
if "// ====== Palettes Theme (Mode Clair / Sombre) ======" in content:
    print("[INFO] Themes deja en haut du fichier")
elif old_first_fn in content:
    content = content.replace(old_first_fn, new_with_themes_top, 1)
    print("[OK] Objet 'themes' place AU DEBUT du fichier (avant DeviaMain)")
    modifs += 1
else:
    print("[ERREUR] function getZone non trouve")
    sys.exit(1)

# ================================================================
# MOD 1 : Ajouter le state themeMode + styles dynamiques dans DeviaMain
# ================================================================
...
# ================================================================
# MOD 2-5 : DIV racine, Header, Nav, Tabs
# (identique a v2)
# ================================================================
...
# ================================================================
# MOD 6 : Toggle Theme dans Parametres
# ================================================================
...
print("  - Objet 'themes' place AVANT toutes les fonctions")
print("  - Plus de Temporal Dead Zone !")
print()
