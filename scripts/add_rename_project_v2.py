...
# -*- coding: utf-8 -*-
"""
DEVIA - Etape B v2 : Menu '...' Renommer sur card projet
Adapte au vrai code: deleteProject (pas handleDeleteProject) + classe devia-delete-btn
"""
...
backup_name = f"devia.jsx.backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}_before_rename_v2"
...
# ================================================================
# MOD 2 : Fonction handleRenameProject
# ================================================================
...
# ================================================================
# MOD 4 : Inserer icone '...' AVANT le bouton supprimer (vraie cible)
# ================================================================
...
if 'title="Plus d\'options"' in content:
    ...
    print("[OK] Menu '...' ajoute aux cards (avant bouton supprimer)")
    modifs += 1
else:
    print("[ERREUR] Bouton supprimer (className devia-delete-btn) non trouve")
    sys.exit(1)

# ================================================================
# MOD 5 : Modale renommage (avant deleteConfirmGroup)
# ================================================================
...
# ================================================================
# MOD 6 : z-index card cumule (groupe + menu)
# ================================================================
