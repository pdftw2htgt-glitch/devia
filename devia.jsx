  ...
  const analyserFichiers = async (fileList) => {
    ...
    try {
      ...
      const sysAnalyse = "Tu analyses des plans/photos de projets de charpente bois. Reponds UNIQUEMENT avec un objet JSON, sans markdown : " +
        ...
        '"ouvrages":null_ou_[{"type":"meme_liste_que_le_champ_type","longueur":num,"largeur":num,"hauteur_murs":num_ou_null,"pente_valeur":num_ou_null,"pente_unite":"degres|pourcent|null","couverture":"meme_liste_que_couverture_ou_null","contre":num_ou_null,"cote":"pignon_gauche|pignon_droit|gouttereau_avant|gouttereau_arriere|null","decalage_m":num_ou_null,"faitage":"parallele|perpendiculaire|null","desc":"role et position du volume en une phrase"}]}. ' +
